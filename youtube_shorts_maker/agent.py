...
shorts_producer_agent = Agent( # SequenceAgent가 필요한데 왜 이렇게 agent를 작성하는가?
    name="ShortsProducerAgent", # workflow agent기 때문에 뇌가 없음
    model=MODEL,
    description=SHORTS_PRODUCER_DESCRIPTION, # 즉 agent가 사용자로부터 요구사항을 받을 수 있어야 함 -> 티키타카
